...
// DynManager extends VMTManager allowing you to attach your own data to an instance as well as retrieve the hook object from a hooked instance.
//
// The VMTHook class hooks by editing the vtable in the dll's .rdata.
// This has the result that every instance using that vtable will be hooked.
//
// A general hint:
// Abuse the __fastcall convention ( look it up in the msdn ) to catch the this pointer.
//
